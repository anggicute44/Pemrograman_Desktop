...
Public Class Form1
    ...
    Private Sub cbPreview_Click(sender As Object, e As EventArgs) Handles cbInterval.Click
    ...
    Private Sub cbInterval_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbInterval.SelectedIndexChanged
